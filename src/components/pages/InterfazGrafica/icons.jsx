...
// ICONO DE PISO
// ============================================
export const IconPiso = ({ size = 30, numero, activo = false, color = '#64748b' }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Círculo del piso */}
      <circle cx="20" cy="20" r="16" fill={activo ? '#1e293b' : '#0f172a'} stroke={activo ? '#22d3ee' : color} strokeWidth="1.5"/>
      
      {/* Número del piso */}
      <text x="20" y="23" textAnchor="middle" fontSize={isGround ? 10 : 12} fontWeight="bold" fill={activo ? '#22d3ee' : color} fontFamily="monospace">
        {label}
      </text>
